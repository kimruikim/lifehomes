<footer>
    <div class="l-footer flex-list">
        <div class="l-footer__logo">
            <a href="/">
                <img src="/assets/img/common/header/logo.png" alt="ライフホームズ株式会社">
            </a>
        </div>
        <div class="l-footer__menu">
            <div class="flex-list">
                ...
                <a href="https://www.instagram.com/lifehomesokinawa/?hl=ja"><img src="/assets/img/common/footer/insta_icon.png" alt="インスタグラム"></a>
            </div>
