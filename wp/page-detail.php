    ...
    <main class="p-works-detail">
        ...
        <div class="works-slider">
            <div class="works-slider__main">
                <div><img src="<?php echo get_template_directory_uri(); ?>/assets/img/works/sample1.png" alt=""></div>
                <div><img src="<?php echo get_template_directory_uri(); ?>/assets/img/works/sample2.png" alt=""></div>
                <div><img src="<?php echo get_template_directory_uri(); ?>/assets/img/works/sample3.png" alt=""></div>
                <div><img src="<?php echo get_template_directory_uri(); ?>/assets/img/works/sample4.png" alt=""></div>
                <div><img src="<?php echo get_template_directory_uri(); ?>/assets/img/works/sample5.png" alt=""></div>
                <div><img src="<?php echo get_template_directory_uri(); ?>/assets/img/works/sample1.png" alt=""></div>
                <div><img src="<?php echo get_template_directory_uri(); ?>/assets/img/works/sample2.png" alt=""></div>
            </div>
